# Generated by Django 4.1.1 on 2023-06-30 05:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch_time', models.CharField(blank=True, max_length=200, null=True)),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.AddField(
            model_name='login',
            name='batch',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.batch'),
        ),
        migrations.AddField(
            model_name='login',
            name='groups',
